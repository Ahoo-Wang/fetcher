...
The following example shows how to create an LLM client with event stream support, similar to the OpenAI client in
the Fetcher project. You can find a production-ready implementation
in [packages/openai/src/chat/chatClient.ts](../openai/src/chat/chatClient.ts).
