...
export default defineConfig({
  ...
  build: {
    ...
    rolldownOptions: {
      external:
        /^(react|react-dom|react-grid-layout|react-day-picker|@base-ui\/react|@ahoo-wang\/fetcher-wow|@ahoo-wang\/fetcher-react|@date-fns\/tz|@tanstack\/react-table|lucide-react|class-variance-authority|clsx|tailwind-merge|recharts)(\/|$)/,
    },
  },
});
