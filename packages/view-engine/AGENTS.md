...
`test/` (45 test files plus `fixtures.ts` and `fixtures/ui.tsx`), `examples/` (`FetcherViewStore.ts`, `PlainRecordWorkbench.tsx`, `quickstart.ts`) and `docs/design.md` sit beside `src/`.
