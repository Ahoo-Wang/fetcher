...
import { ArrowDownUpIcon, GripVerticalIcon, XIcon } from 'lucide-react';
    ...
    >
      ...
      >
            ...
            const options = [
              {
                ...
                label: numeric ? '从低到高' : date ? '从早到晚' : '正序',
              },
              {
                value: SortDirection.DESC,
                label: numeric ? '从高到低' : date ? '从晚到早' : '倒序',
              },
            ];
            return (
              <li
                ...
                className="fve:relative fve:grid fve:grid-cols-[1.75rem_minmax(0,1fr)_7rem_1.75rem] fve:items-center fve:gap-1 fve:rounded-md fve:border fve:p-1 fve:data-dragging:opacity-50"
              >
                ...
                >
                  <SelectTrigger
                    aria-label={`${labelOf(item.field)}排序`}
        ...
        <Select
          ...
          onValueChange={field => {
            if (field && canAdd && available.some(item => item.field === field))
