...
export const zhCN: ViewMessages = {
  ...
  'label.sort.none': '这些行没有指定顺序。',
  'label.sort.asc': '升序',
  'label.sort.desc': '降序',
  'label.sort.more': '+{count}',
  'label.sort.direction': '{field} 的排序方向',
  'label.sort.remove': '不再按 {field} 排序',
  'label.sort.add': '添加排序字段',
  'label.summary.function.none': '不汇总',
  'label.summary.function.SUM': '合计',
  'label.summary.function.AVG': '平均',
  'label.summary.function.MIN': '最小值',
  'label.summary.function.MAX': '最大值',
  'label.summary.function.COUNT': '计数',
