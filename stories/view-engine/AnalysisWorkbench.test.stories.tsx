...
export const FollowUpFocus: Story = {
  ...
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
    // Read once the legend has named every slice: three paths can be drawn
    // a frame before the legend catches up, and a name read then is null.
    const before = ['华南', '华北', zhCN['label.chart.other']];
    await waitFor(() =>
