...
各 cell props、CurrencyFormatOptions、CalendarFormats 和准确常量见下文；[Cells.stories.tsx](https://github.com/Ahoo-Wang/fetcher/blob/5.x/stories/viewer/Cells.stories.tsx#L1) 提供交互渲染示例。
