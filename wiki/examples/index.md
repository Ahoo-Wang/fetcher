...
description: Run deterministic HTTP, React, and 5.x Viewer examples with clear consumer and repository instructions.
---
...
| [Viewer](./viewer.md) (5.x) | Four rows, paging, name sorting, Active filtering, and saved-view confirmation | Mount the local component with compatible React/Viewer peers                   |
