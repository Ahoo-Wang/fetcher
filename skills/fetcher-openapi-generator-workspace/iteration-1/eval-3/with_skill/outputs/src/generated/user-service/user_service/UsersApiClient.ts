...
export class UsersApiClient implements ApiMetadataCapable {
  ...
  user(
    @request() httpRequest: ParameterRequest<CreateUserCommand>,
   ...
   */
  @del('/tenant/{tenantId}/users/{userId}', {
    resultExtractor: ResultExtractors.Response,
  })
  aggregate(
   ...
   * - path: `/tenant/{tenantId}/users/{userId}`
   */
  @put('/tenant/{tenantId}/users/{userId}', {
    resultExtractor: ResultExtractors.Response,
  })
  updateUser(
    @path('userId') userId: string,
    @request() httpRequest: ParameterRequest<UpdateUserCommand>,
    @attribute() attributes?: Record<string, any>,
  ): Promise<Response> {
    throw autoGeneratedError(userId, httpRequest, attributes);
  }
