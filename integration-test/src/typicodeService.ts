...
import { api, autoGeneratedError, body, get, path, post, put, patch, del, query } from '@ahoo-wang/fetcher-decorator';
import { Album, Post, Todo, typicodeFetcher } from './typicodeFetcher';
...
export class TypicodePostService {
  ...
  @del('/{postId}')
  deletePost(@path('postId') postId: string): Promise<void> {
    throw autoGeneratedError();
  }
